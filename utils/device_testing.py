...
def check_graphics_card_control_pannel(OSValidationDict):
    powershellComand = "import-Module .\\utils\\powershell\\disguiseDevicesQA -Force -DisableNameChecking; Test-GraphicsCardControlPannel -OSVersion \"" + OSValidationDict["OSVersion"].replace( "\"", "`\"" ) + "\" -userInputMachineName \"" + OSValidationDict["ServerName"].replace( "\"", "`\"" ) + "\"" + " -pathToOSValidationTemplate " + OSValidationDict["OSValidationTemplatePath"]
...
def check_matrox_capture_cards(OSValidationDict):
    powershellComand = "import-Module .\\utils\\powershell\\disguiseDevicesQA -Force -DisableNameChecking; Test-CaptureCard -OSVersion \"" + OSValidationDict["OSVersion"].replace( "\"", "`\"" ) + "\" -userInputMachineName \"" + OSValidationDict["ServerName"].replace( "\"", "`\"" ) + "\"" + " -CaptureCardManufacturer 'MATROX'" + " -pathToOSValidationTemplate " + OSValidationDict["OSValidationTemplatePath"]
...
def check_deltacast_capture_cards(OSValidationDict):
    powershellComand = "import-Module .\\utils\\powershell\\disguiseDevicesQA -Force -DisableNameChecking; Test-CaptureCard -OSVersion \"" + OSValidationDict["OSVersion"].replace( "\"", "`\"" ) + "\" -userInputMachineName \"" + OSValidationDict["ServerName"].replace( "\"", "`\"" ) + "\"" + " -CaptureCardManufacturer 'deltacast'" + " -pathToOSValidationTemplate " + OSValidationDict["OSValidationTemplatePath"]
...
def check_bluefish_capture_cards(OSValidationDict):
    powershellComand = "import-Module .\\utils\\powershell\\disguiseDevicesQA -Force -DisableNameChecking; Test-CaptureCard -OSVersion \"" + OSValidationDict["OSVersion"].replace( "\"", "`\"" ) + "\" -userInputMachineName \"" + OSValidationDict["ServerName"].replace( "\"", "`\"" ) + "\"" + " -CaptureCardManufacturer 'bluefish'" + " -pathToOSValidationTemplate " + OSValidationDict["OSValidationTemplatePath"]
