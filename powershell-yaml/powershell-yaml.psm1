...
function Invoke-LoadFile {
    ...
    $yamlAssemblyByteArray= [System.IO.File]::ReadAllBytes($powershellYamlDotNetAssemblyPath)
    $serializerAssemblyByteArray= [System.IO.File]::ReadAllBytes($serializerAssemblyPath)
    $yamlAssembly = [System.Reflection.Assembly]::Load($yamlAssemblyByteArray)
    $serializerAssembly = [System.Reflection.Assembly]::Load($serializerAssemblyByteArray)
